...
public class HotelDealData {
	
	String movingAverageScore;
    String rawAppealScore;
    ...
    String description;
    String destination;
    String longDestinationName;
    String regionId;
    String statusCode;
    String statusDescription;
    String baseRate;
    String originalBaseRate;
    String currency;
    String taxesAndFees;
    String totalRate;
    ...
    String dealDeepLink;
    String similarDeepLink;
    Double starRating;
    String guestRating;
    String lengthofStay;
    String pricePerNight;
    String originalPricePerNight;
    ...
    String imageUrl;
    String language;
    String mandatoryTaxesAndFees;
    String promotionTag;
    String carPackage;
    String carPackageScore;
	 ...
	 */
	public String getOriginalBaseRate() {
		return originalBaseRate;
	}
	/**
	 * @param originalBaseRate the originalBaseRate to set
	 */
	public void setOriginalBaseRate(String originalBaseRate) {
	 ...
	 * @return the isDRR
	 */
	public String getIsDRR() {
		return isDRR;
	}
	/**
	 * @param isDRR the isDRR to set
	 */
	public void setIsDRR(String isDRR) {
		this.isDRR = isDRR;
	}
	/**
	 ...
	 */
	public void setIsAllInclusive(String isAllInclusive) {
	 ...
	 */
	public String getMandatoryTaxesAndFees() {
		return mandatoryTaxesAndFees;
	}
	/**
	 * @param mandatoryTaxesAndFees the mandatoryTaxesAndFees to set
	 */
	public void setMandatoryTaxesAndFees(String mandatoryTaxesAndFees) {
